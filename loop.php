...
<div id="right">
<h1 class="front-h1">Friday Hacks<span><a href=" <?php echo home_url( '/' ); ?>sponsor">Supported</a> by IDA, Google, RIM. <br/>Every Friday @ <a href="<?php echo home_url( '/' ); ?>fridayhacks">6pm SR3 COM1, School of Computing</a></span></h1>
