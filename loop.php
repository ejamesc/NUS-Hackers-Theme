...
<div id="right">
<h1 class="front-h1">Friday Hacks<span><a href=" <?php echo home_url( '/' ); ?>Supported</a> by IDA, Google, RIM, <a class="subtle" href="http://geeksphere.net">Geeksphere.net</a>. <br/>Every Friday @ <a href="<?php echo home_url( '/' ); ?>fridayhacks">6pm UTown ERC Seminar Room 2</a></span></h1>
